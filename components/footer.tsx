...
const Footer = () => {
  ...
  return (
    <footer
      ...
      className="bg-white print:hidden border-t-2 border-primary"
    >
          ...
          <div>
            <div className="text-teal-600">
              <Image
                ...
                src={Logo}
                alt="The Fairfield Programming Association Inc. Logo"
              />
            </div>

            <p className="max-w-xs mt-4 text-gray-500">37th and O St NW</p>
            ...
            <ul className="flex gap-6 mt-8">
              ...
              <li>
                <a
                  ...
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:opacity-75 p-auto"
                >
                  <span className="sr-only">Instagram</span>
                  <svg
